...
> **For the current release state, `CHANGELOG.md` is authoritative.** This file is a periodic deep-snapshot; last full refresh 2026-05-14 (v0.4.0-era). Current release is **v0.6.1** (library-migrations + multi-provider + onLayerEvent — see CHANGELOG). Read alongside `../../README.md` (orientation), `../../.claude/CLAUDE.md` (working principles), `../../ROADMAP.md` (phased plan), `../../CHANGELOG.md` (release history).
